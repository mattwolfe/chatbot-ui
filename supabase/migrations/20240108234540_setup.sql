...
AS $$
DECLARE
  project_url TEXT := 'https://fbsfekqnlcfhqdsedwvy.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZic2Zla3FubGNmaHFkc2Vkd3Z5Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNzc4NjgwMSwiZXhwIjoyMDIzMzYyODAxfQ.ZwDvWjHWU6hCnA_OoXw67zmXJx_oHPo4sFjkLxNh3m0'; -- full access needed for http request to storage
